  ...
  return (
    ...
    >
      <Modal.Body>
        ...
        >
          <ReactStars count={5} value={1} size={size} />
        </Button>
        <Button
          block
        ...
        >
          <ReactStars count={5} value={2} size={size} />
        </Button>
        <Button
          block
        ...
        >
          <ReactStars count={5} value={3} size={size} />
        </Button>
        <Button
          block
        ...
        >
          <ReactStars count={5} value={4} size={size} />
        </Button>
        <Button
          block
        ...
        >
          <ReactStars count={5} value={5} size={size} />
        </Button>
      </Modal.Body>
    </Modal>
  );

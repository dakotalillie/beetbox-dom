...
class CircleOfFifths extends React.Component {
  ...
  determineKeyClassName = keyNum => {
    const mode = this.state.mode;
    const { activeKey, activeKeys, multiple } = this.props;
    const majorKeys = [
      'C',
      'G',
      'D',
    ...
    if (!multiple) {
      return (
        'key' +
        ((mode === 'major' && activeKey === majorKeys[keyNum - 1]) ||
        (mode === 'minor' && activeKey === minorKeys[keyNum - 1])
          ? ' active'
          : '')
      );
    } else {
      return (
        'key' +
        ((mode === 'major' && activeKeys.includes(majorKeys[keyNum - 1])) ||
        (mode === 'minor' && activeKeys.includes(minorKeys[keyNum - 1]))
          ? ' active'
          : '')
      );
    }
        ...
        <div className="circle-of-fifths">
          <svg id="svg64" width="418.66666" viewBox="0 0 418.66666 429.33334">
            ...
            <path
              ...
              id="key1"
              className={this.determineKeyClassName(1)}
              onClick={() => this.props.handleClick(1, this.state.mode)}
            />
            <path
              ...
              id="key2"
              className={this.determineKeyClassName(2)}
              onClick={() => this.props.handleClick(2, this.state.mode)}
            />
            <path
              ...
              id="key3"
              className={this.determineKeyClassName(3)}
              onClick={() => this.props.handleClick(3, this.state.mode)}
            />
            <path
              ...
              id="key4"
              className={this.determineKeyClassName(4)}
              onClick={() => this.props.handleClick(4, this.state.mode)}
            />
            <path
              ...
              id="key5"
              className={this.determineKeyClassName(5)}
              onClick={() => this.props.handleClick(5, this.state.mode)}
            />
            <path
              ...
              id="key6"
              className={this.determineKeyClassName(6)}
              onClick={() => this.props.handleClick(6, this.state.mode)}
            />
            <path
              ...
              id="key7"
              className={this.determineKeyClassName(7)}
              onClick={() => this.props.handleClick(7, this.state.mode)}
            />
            <path
              ...
              id="key8"
              className={this.determineKeyClassName(8)}
              onClick={() => this.props.handleClick(8, this.state.mode)}
            />
            <path
              ...
              id="key9"
              className={this.determineKeyClassName(9)}
              onClick={() => this.props.handleClick(9, this.state.mode)}
            />
            <path
              ...
              id="key10"
              className={this.determineKeyClassName(10)}
              onClick={() => this.props.handleClick(10, this.state.mode)}
            />
            <path
              ...
              id="key11"
              className={this.determineKeyClassName(11)}
              onClick={() => this.props.handleClick(11, this.state.mode)}
            />
            <path
              ...
              id="key12"
              className={this.determineKeyClassName(12)}
              onClick={() => this.props.handleClick(12, this.state.mode)}
            />
          </svg>
        </div>
